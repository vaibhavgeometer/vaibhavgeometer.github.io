...
- **Verified Master Answer Keys**: Complete IIT official answer keys and accepted numeric ranges for all 22 years.

### 🎓 2. Topic-Wise Mock Test Series (300 Official PYQs)
...
### 📑 3. 14 High-Yield Formula Cheat Sheets
- Comprehensive quick-revision formula sheets covering Real Analysis, Multivariable Calculus, Ordinary Differential Equations, Linear Algebra, and Group Theory.

### ⚡ 4. Authentic CBT Exam Simulator
...
### 📄 5. Question Bank PDF & LaTeX Source
...
│   ├── PYQs_Answer Keys/                      # 14 official master answer key PDFs (2005–2026)
│   │   ├── MA2005-2013_Key.pdf
│   │   ├── MA2014_Key.pdf
...
│       ├── 2015/ ... 2021/                    # CBT era screenshots (60 Qs per year)
...
│       ├── questions_data.js                  # 885 PYQ database with options, keys & proofs
...
└── scripts/
    ...
    └── generate_all_22_years_data.py          # Master data generator for all 22 years
```
