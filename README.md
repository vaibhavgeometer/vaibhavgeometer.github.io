# IIT JAM Mathematics (MA) — 22-Year (2005–2026) Mock Test Series & Study Portal 📐

[![License: MIT](https://img.shields.io/badge/License-MIT-blue.svg)](LICENSE)
[![Live Website](https://img.shields.io/badge/Live%20Portal-vaibhavgeometer.github.io-success?logo=github)](https://vaibhavgeometer.github.io/)
[![GitHub Repository](https://img.shields.io/badge/GitHub-vaibhavgeometer%2Fvaibhavgeometer.github.io-181717?logo=github)](https://github.com/vaibhavgeometer/vaibhavgeometer.github.io)
...
### 🏛 1. 22-Year Official Mock Test Series (2005–2026 • 885 Official PYQs)
- **Complete Historical Coverage**: Full archive of official IIT JAM Mathematics examination papers from 2005 through 2026.
- **Two Distinct Exam Eras**:
  - **Modern & CBT Era (2015–2026)**: 60 questions per paper with authentic Section A (MCQ 1M & 2M), Section B (MSQ 2M), and Section C (NAT 1M & 2M) totalling 100 Marks (180 min).
  - **Classic Era (2005–2014)**: Objective papers (15 to 35 questions per year) reflecting the foundational era of IIT JAM.
...
- **Interactive Question Palette**:
  - 🟢 **Answered**: Saved responses evaluated for marks.
  - 🔴 **Not Answered**: Visited questions left unanswered.
  - ⚪ **Not Visited**: Unseen questions.
  - 🟣 **Marked for Review**: Flagged questions to revisit before submission.
  - 🟣🟢 **Answered & Marked for Review**: Evaluated during final submission.
- **Virtual Scientific Calculator**:
  - Floating, draggable scientific calculator matching CBT interfaces.
  - Algebraic operations, trigonometric ($\sin, \cos, \tan$) and inverse functions, hyperbolic functions ($\sinh, \cosh$), logarithm ($\ln, \log_{10}$), exponentiation ($e^x, x^y, x^2, x^3$), square/cube roots, factorials, constants ($\pi, e$), and memory registers ($MC, MR, M+, M-$).
- **Instant Analytics & Scorecard**:
  - Real-time score computation with positive and negative marking breakdown.
  - Percentage accuracy, total time spent, and performance evaluation badges.
  - Interactive filterable question review (All, Correct, Incorrect, Unattempted).
...
- Programmatically accessible metadata for all 885 questions:
  ```json
  {
    ...
    "marks": 1,
    "topic": "Real Analysis",
    "sub_topic": "Functions of One Real Variable",
    "answer": "D"
  }
  ```
...
## 📊 Complete Test Series Architecture (58 Tests Total)

```
Total Test Suites (58)
├── 🏛 22 Full-Length Year Mock Tests (2005–2026 • 885 PYQs)
├── ⚡ 27 Era-Based Subtopic Tests (3 Eras × 9 Subtopics)
└── 🎯 9 Comprehensive Full-Archive Subtopic Tests (2005–2026 • 794 In-Syllabus PYQs)
```
...
| :---: | :--- | :---: | :---: | :---: | :--- | :---: |
| **1.1** | `Sequences and Series of Real Numbers` | **124** | 270 | 372 min | Real Analysis | [Cheat Sheet](assets/cheat-sheets/Sequence_of_Real_Numbers_Cheat_Sheet.pdf) |
| **1.2** | `Functions of One Real Variable` | **158** | 335 | 474 min | Real Analysis | [Cheat Sheet](assets/cheat-sheets/Continuity_and_Differentiability_Cheat_Sheet.pdf) |
| **2.1** | `Functions of Two or Three Real Variables` | **73** | 149 | 219 min | Multivariable Calculus & ODE | [Cheat Sheet](assets/cheat-sheets/Functions_of_Several_Variables_Cheat_Sheet.pdf) |
| **2.2** | `Integral Calculus` | **66** | 139 | 198 min | Multivariable Calculus & ODE | [Cheat Sheet](assets/cheat-sheets/Integral_Calculus_Cheat_Sheet.pdf) |
| **2.3** | `Differential Equations` | **109** | 255 | 327 min | Multivariable Calculus & ODE | [Cheat Sheet](assets/cheat-sheets/Differential_Equations_Cheat_Sheet.pdf) |
| **3.1** | `Basic Algebra` | **3** | 6 | 15 min | Linear Algebra & Algebra | [Cheat Sheet](assets/cheat-sheets/Basic_Algebra_Cheat_Sheet.pdf) |
| **3.2** | `Matrices and Systems of Linear Equations` | **91** | 183 | 273 min | Linear Algebra & Algebra | [Cheat Sheet](assets/cheat-sheets/Linear_Algebra_Master_Cheat_Sheet.pdf) |
| **3.3** | `Finite Dimensional Vector Spaces` | **78** | 184 | 234 min | Linear Algebra & Algebra | [Cheat Sheet](assets/cheat-sheets/Linear_Algebra_Vector_Spaces_Cheat_Sheet.pdf) |
| **3.4** | `Groups` | **92** | 198 | 276 min | Linear Algebra & Algebra | [Cheat Sheet](assets/cheat-sheets/Group_Theory_Master_Cheat_Sheet.pdf) |
| | **Total In-Syllabus Questions** | **794** | **1,719** | — | **All 3 Core Syllabus Sections** | |
...
## 📑 14 High-Yield Formula Cheat Sheets

All cheat sheets are formatted in vector PDF and accessible directly from the portal:

| Section | Topic | Pages | Document Link |
| :--- | :--- | :---: | :--- |
| **Real Analysis** | Sequences of Real Numbers | 1 | [Sequence_of_Real_Numbers_Cheat_Sheet.pdf](assets/cheat-sheets/Sequence_of_Real_Numbers_Cheat_Sheet.pdf) |
| **Real Analysis** | Series of Real Numbers | 1 | [Series_of_Real_Numbers_Cheat_Sheet.pdf](assets/cheat-sheets/Series_of_Real_Numbers_Cheat_Sheet.pdf) |
| **Real Analysis** | Series Convergence Tests & Power Series | 2 | [Series_Convergence_Tests_Cheat_Sheet.pdf](assets/cheat-sheets/Series_Convergence_Tests_Cheat_Sheet.pdf) |
| **Real Analysis** | Continuity & Differentiability | 2 | [Continuity_and_Differentiability_Cheat_Sheet.pdf](assets/cheat-sheets/Continuity_and_Differentiability_Cheat_Sheet.pdf) |
| **Real Analysis** | Riemann Integration & Definite Integrals | 2 | [Riemann_Integration_Cheat_Sheet.pdf](assets/cheat-sheets/Riemann_Integration_Cheat_Sheet.pdf) |
| **Real Analysis** | Max/Min, L'Hospital & Power Series Operations | 2 | [Multivariable_and_Power_Series_Supplemental.pdf](assets/cheat-sheets/Multivariable_and_Power_Series_Supplemental.pdf) |
| **Calculus & ODE** | Functions of Several Variables | 1 | [Functions_of_Several_Variables_Cheat_Sheet.pdf](assets/cheat-sheets/Functions_of_Several_Variables_Cheat_Sheet.pdf) |
| **Calculus & ODE** | Integral Calculus (Double & Triple Integrals) | 2 | [Integral_Calculus_Cheat_Sheet.pdf](assets/cheat-sheets/Integral_Calculus_Cheat_Sheet.pdf) |
| **Calculus & ODE** | Ordinary Differential Equations (ODE) | 1 | [Differential_Equations_Cheat_Sheet.pdf](assets/cheat-sheets/Differential_Equations_Cheat_Sheet.pdf) |
| **Algebra & Linear Algebra** | Basic Algebra (P&C, Binomial Theorem) | 1 | [Basic_Algebra_Cheat_Sheet.pdf](assets/cheat-sheets/Basic_Algebra_Cheat_Sheet.pdf) |
| **Algebra & Linear Algebra** | Linear Algebra Master Sheet (Matrices & Eigenvalues) | 3 | [Linear_Algebra_Master_Cheat_Sheet.pdf](assets/cheat-sheets/Linear_Algebra_Master_Cheat_Sheet.pdf) |
| **Algebra & Linear Algebra** | Finite Dimensional Vector Spaces | 1 | [Linear_Algebra_Vector_Spaces_Cheat_Sheet.pdf](assets/cheat-sheets/Linear_Algebra_Vector_Spaces_Cheat_Sheet.pdf) |
| **Algebra & Linear Algebra** | Group Theory Quick Reference | 1 | [Group_Theory_Summary.pdf](assets/cheat-sheets/Group_Theory_Summary.pdf) |
| **Algebra & Linear Algebra** | Group Theory Master Sheet (Gallian Review) | 2 | [Group_Theory_Master_Cheat_Sheet.pdf](assets/cheat-sheets/Group_Theory_Master_Cheat_Sheet.pdf) |

---

## ⚖ Real Exam Marking Scheme

The simulator strictly enforces the official IIT JAM marking guidelines:

```
┌─────────────────────────┬──────────────┬───────────────┬───────────────────────────────┐
│ Section / Question Type │ Correct Mark │ Negative Mark │ Evaluation Rules              │
├─────────────────────────┼──────────────┼───────────────┼───────────────────────────────┤
│ Section A: MCQ (1-Mark) │ +1.00        │ -0.33 (-1/3)  │ Single option correct         │
│ Section A: MCQ (2-Mark) │ +2.00        │ -0.67 (-2/3)  │ Single option correct         │
│ Section B: MSQ (2-Mark) │ +2.00        │  0.00         │ All correct options required; │
│                         │              │               │ No partial marks or negatives │
│ Section C: NAT (1-Mark) │ +1.00        │  0.00         │ Accepted within numeric range │
│ Section C: NAT (2-Mark) │ +2.00        │  0.00         │ Accepted within numeric range │
└─────────────────────────┴──────────────┴───────────────┴───────────────────────────────┘
```
...
│       └── 2022/ ... 2026/                    # Modern CBT era screenshots
├── mock-test/
│   ├── index.html                             # Redirects to main portal
│   ├── test.html                              # Interactive CBT mock test simulator
│   ├── css/
...
│       ├── questions_data.js                  # Master dataset: 22 Years + 27 Eras + 9 Full-Archive
...
Because the portal is built using standard web standards without heavy build tooling, you can run it locally with any simple HTTP server:

### Option 1: Python 3
```bash
# Clone the repository
git clone https://github.com/vaibhavgeometer/vaibhavgeometer.github.io.git
cd vaibhavgeometer.github.io
...
Simply double-click or open `index.html` directly in Chrome, Edge, Firefox, Brave, or Safari.
...
- **Exam Content**: All official questions, question screenshots, syllabus descriptions, and master answer keys are sourced from official IIT JAM Mathematics (MA) examination papers conducted by various Indian Institutes of Technology (2005–2026).
- **Curated & Developed with ❤️ by [Vaibhav Geometer](https://github.com/vaibhavgeometer)**.